...
@router.post("/compras/nueva/", tags=["Compras"], summary="Registrar una nueva compra", description="Este endpoint registra una nueva los detalles en la tabla correspondiente. Para agregar libros, indicar 'id_libro', 'cantidad' y 'precio'")
